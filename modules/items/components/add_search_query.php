                ...
                for ($i = 0, $n = sizeof($search_keywords); $i < $n; $i++)
                {
                    switch ($search_keywords[$i])
                    {
                        ...
                        default:
                            ...
                            {
                                $where_str .= "(es.field_7 REGEXP '[[:<:]]" . db_input($keyword) . "[[:>:]]' or es.field_8 REGEXP '[[:<:]]" . db_input(addslashes($keyword)) . "[[:>:]]' or es.field_9 REGEXP '[[:<:]]" . db_input(addslashes($keyword)) . "[[:>:]]')";
                            } else
                            {
                    ...
                    for ($i = 0, $n = sizeof($search_keywords); $i < $n; $i++)
                    {
                        switch ($search_keywords[$i])
                        {
                            ...
                            default:
                                ...
                                if ($_POST['search_type_match'] == 'true')
                                {
                                    $where_str .= "es.field_" . $heading_field_id . " REGEXP '[[:<:]]" . db_input(addslashes($keyword)) . "[[:>:]]'";
                                } else
                                {
                ...
                for ($i = 0, $n = sizeof($search_keywords); $i < $n; $i++)
                {
                    switch ($search_keywords[$i])
                    {
                        ...
                        default:
                            ...
                            if ($_POST['search_type_match'] == 'true')
                            {
                                $where_str .= "AES_DECRYPT(e.field_" . $field['id'] . ",'" . db_input(DB_ENCRYPTION_KEY) . "') REGEXP '[[:<:]]" . db_input(addslashes($keyword)) . "[[:>:]]'";
                            } else
                            {
                ...
                for ($i = 0, $n = sizeof($search_keywords); $i < $n; $i++)
                {
                    switch ($search_keywords[$i])
                    {
                        ...
                        default:
                            ...
                            if ($_POST['search_type_match'] == 'true')
                            {
                                $where_str .= "e.field_" . $field['id'] . " REGEXP '[[:<:]]" . db_input(addslashes($keyword)) . "[[:>:]]'";
                            } else
                            {
