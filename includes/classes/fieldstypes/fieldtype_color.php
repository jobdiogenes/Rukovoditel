...
class fieldtype_color
{
    ...
    function render($field, $obj, $params = array())
    {
        ...
        {
            $choices = global_lists::get_choices_with_color($cfg->get('use_global_list'), ($field['is_required'] == 1 ? false : true), '', $obj['field_' . $field['id']], true);
            $default_id = global_lists::get_choices_default_id($cfg->get('use_global_list'));
        }
        else
        {
            $choices = fields_choices::get_choices_with_color($field['id'], ($field['is_required'] == 1 ? false : true), '', $cfg->get('display_choices_values'), $obj['field_' . $field['id']], true);
