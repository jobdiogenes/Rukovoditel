...
class fieldtype_checkboxes
{
  ...
  {                
    ...
    else
    {
        ...
        return '<div class="checkbox-list ' . ($attributes['ul-class']=='list-inline' ? ' form-control-static':'') . '">' . select_checkboxes_ul_tag('fields[' . $field['id'] . ']',$choices,$value,$attributes) . '</div>';
    }
  }
